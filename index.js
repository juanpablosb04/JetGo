document.addEventListener("DOMContentLoaded", function () {
  ...
  buttonBogota.addEventListener("click", function () {
    ...
    if (!isExpanded) {
      ...
      pBogota.classList.remove("visible");
  ...
  buttonNewYork.addEventListener("click", function () {
    ...
    if (!isExpanded) {
      ...
      setTimeout(() => {
        pNewYork.classList.add("visible");
      }, 50);
  ...
  buttonValencia.addEventListener("click", function () {
    ...
    if (!isExpanded) {
      ...
      setTimeout(() => {
        pValencia.classList.add("visible");
      }, 50);
      ...
      pValencia.classList.remove("visible");
